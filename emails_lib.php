...
class email
{
    protected $siteName = 'Akusinachi Homes Limited';
    protected $siteDomain = 'akusinachihomesltd.com';
...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f5f6fa;">
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding-bottom:25px">
                                    <a href="https://akusinachihomesltd.com/"><img style="height: 40px" src="https://akusinachihomesltd.com/img/logo.png" alt="logo"></a>
                        ...
                        <tbody>
                            <tr>
                                <td style="text-align: center; padding:25px 20px 0;">
                                    <p style="font-size: 13px;">Copyright © ' . $d . ' Akusinachi Homes Limited. All rights reserved.</p>
                                    <ul style="margin: 10px -4px 0;padding: 0;">
                                        <li style="display: inline-block; list-style: none; padding: 4px;"><a style="display: inline-block; height: 30px; width:30px;border-radius: 50%; background-color: #ffffff" href="https://facebook.com/"><img style="width: 30px" src="https://akusinachihomesltd.com/mail_images/brand-b.png" alt="brand"></a></li>
                                        <li style="display: inline-block; list-style: none; padding: 4px;"><a style="display: inline-block; height: 30px; width:30px;border-radius: 50%; background-color: #ffffff" href="https://twitter.com/"><img style="width: 30px" src="https://akusinachihomesltd.com/mail_images/brand-e.png" alt="brand"></a></li>
                                        <li style="display: inline-block; list-style: none; padding: 4px;"><a style="display: inline-block; height: 30px; width:30px;border-radius: 50%; background-color: #ffffff" href="https://youtube.com/"><img style="width: 30px" src="https://akusinachihomesltd.com/mail_images/brand-d.png" alt="brand"></a></li>
                                    </ul>
                                    <p style="padding-top: 15px; font-size: 12px;">For more detail contact us: info@akusinachihomesltd.com, support@akusinachihomesltd.com</p><p style="padding-top: 15px; font-size: 12px;">This email was sent to you as a registered user of <a style="color: #6576ff; text-decoration:none;" href="https://akusinachihomesltd.com/">Akusinachi Homes Limited</a>.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
    ...
    public function generalMessage($subjt, $message, $email, $siteName, $siteDomain)
    {
        ...
        $headers .= 'From: Akusinachi Homes Limited <support@akusinachihomesltd.com>' . "\r\n";
    ...
    {
        $to  = $emailR;
        $subject = 'You have a new direct sign-up on akusinachihomesltd.com';
        $info = 'Dear ' . $nameR . '(' . $usernameR . '), <br><br /> You have a new direct referral sign-up on <br />akusinachihomesltd.com<br />User: ' . $usernameM . '<br />Name: ' . $nameM . '<br>E-mail: ' . $emailM . '<br><br >Thank You.';
        $content = $info; //self::generalBody($info);
        $headers = "MIME-Version: 1.0" . "\r\n";
        $headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
        $headers .= 'From: Akusinachi Homes Limited <support@akusinachihomesltd.com>' . "\r\n";
    ...
    {
        $to  = 'info@akusinachihomesltd.com';
    ...
    {
        $to  = 'support@akusinachihomesltd.com';
        $subject = $subject;
        ...
        $headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
        $headers .= 'From: Akusinachi Homes Limited <support@akusinachihomesltd.com>' . "\r\n";
        $headers = 'CC: akusinachihomesltd@gmail.com';
        $retval = @mail($to, $subject, $content, $headers);
        if ($retval) {
    ...
    public function paymentNotification($amount, $plan, $coin, $id, $name, $email)
    {
        ...
        $header .= 'From: Akusinachi Homes Limited <support@akusinachihomesltd.com>' . "\r\n";
...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f5f6fa;">
    ...
    public function ActivateMail($email, $password, $fullname)
    {
        ...
        <p>Follow this link to verify your account. <a href="https://akusinachihomesltd.com/ActivateMail/activate.php?id=' . $email . '&ip=' . $password . '">Verify Account</a> </p>
        <br />
        <p>Best regards, Akusinachi Homes Limited Team<br /><br /> Powered by: <a href="https://akusinachihomesltd.com">Akusinachi Homes Limited</a></p>';
        $content = $message; //self::generalBody($message);
        $header = "MIME-Version: 1.0" . "\r\n";
        $header .= "Content-type:text/html;charset=UTF-8" . "\r\n";
        $header .= 'From: Akusinachi Homes Limited <support@akusinachihomesltd.com>' . "\r\n";
